...
*** C-like Languages (C, C++, Java)
  ...
  #+begin_src emacs-lisp
    (use-package cc-mode
          ...
          ;; Bind keys in c-mode-map
          (define-key c-mode-map (kbd "C-c C-c") #'my/compile-smart)
          (define-key c-mode-map (kbd "C-c C-r") #'my/compile-and-run-c)
          (define-key c-mode-map (kbd "C-c C-a") #'my/c-generate-assembly)
          (define-key c-mode-map (kbd "C-c C-h") #'my/c-hexdump-binary)
          ...
          ;; Bind keys in java-mode-map
          (define-key java-mode-map (kbd "C-c C-c") #'my/compile-smart)
          (define-key java-mode-map (kbd "C-c C-r") #'my/compile-and-run-java)
          (define-key java-mode-map (kbd "C-c C-a") #'my/java-generate-bytecode)
          (define-key java-mode-map (kbd "C-c C-h") #'my/java-hexdump-class)
...
*** JavaScript
  ...
  #+begin_src emacs-lisp
    ...
    (use-package js
          ...
          (define-key js-mode-map (kbd "C-c C-r") #'my/run-js)
...
*** Rust
  ...
  #+begin_src emacs-lisp
    (use-package rust-mode
           ...
           :mode "\\.rs\\'"
           :config
           ;; Enable automatic code formatting on save using rustfmt
           (setq rust-format-on-save t)
           (define-key rust-mode-map (kbd "C-c C-c") #'my/compile-smart)
           (define-key rust-mode-map (kbd "C-c C-r") #'my/compile-and-run-rust)
           (my/say "Rust mode ready with format-on-save."))

         (use-package cargo
           :ensure t
           :hook (rust-mode . cargo-minor-mode)
           :config
           ;; Unbind C-c C-c from cargo to let my/compile-smart execute instantly
           (define-key cargo-minor-mode-map (kbd "C-c C-c") nil)
           ;; Bind the cargo command map prefix to C-c C-k
           (define-key cargo-minor-mode-map
             (kbd "C-c C-k") 'cargo-minor-mode-command-map)
           (setq cargo-process--command-flags '("--color" "always"))
           (my/say "Cargo minor mode loaded with C-c C-k prefix."))
...
*** R
  ...
  #+begin_src emacs-lisp
    (use-package ess
          ...
          (define-key ess-r-mode-map (kbd "C-c C-r") #'my/run-r)
