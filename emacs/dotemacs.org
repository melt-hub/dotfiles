...
**** AUCTeX
  ...
  A comprehensive environment offering document compilation and macro
  expansions.
...
** Automatic Org Header Generator

  Automates prepending structured meta title markers and global author headers
  to the top of empty Org files.
