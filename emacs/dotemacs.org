...
**** Compiler Configuration and Execution
  ...
  Provides base configuration for C and C++ compilation, including compiler
  resolution and flag definition. Contains commands to compile and execute the
  active buffer directly.
