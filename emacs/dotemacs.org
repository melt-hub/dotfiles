...
** Rust Development
   ...
   Configuration for Rust syntax highlighting and Cargo integration:
...
** Multimedia (EMMS)
   ...
   EMMS is the Emacs Multimedia System. It lets you control MPV from Emacs
   and integrate your playlist with your workflow.
