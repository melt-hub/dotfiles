...
*** C and C++ Development
  ...
  Standard CC-mode configuration for C and C++ with automated 
...
*** Java Development
  ...
  Basic Java support using the built-in java-mode.
...
*** JavaScript Development
  ...
  Lightweight JavaScript support with integration for Node.js 
  as an interpreter.
